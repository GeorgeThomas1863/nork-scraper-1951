...
import UTIL from "./util-model.js"; // Update the path
import dbModel from "./db-model.js"; // Update the path
import CONFIG from "../config/scrape-config.js"; // Update the path
import YourClass from "./article-model.js"; // Update the path with the actual class that contains buildArticleList
